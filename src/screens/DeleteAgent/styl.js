...
export default {
  ...
  itemTitleDelet: {
    color: '#fff',  borderColor: '#ffffff', borderWidth: 1, fontFamily: Platform.OS === 'ios' ? 'Chosence' : 'Chosence Regular', fontSize: 17, paddingLeft: 5, paddingRight: 5,paddingBottom:5,paddingTop:5
  },
  ...
  itemTitleWrapper_1: {
    width: '20%', backgroundColor: '#3f3f3f', height: 74, justifyContent: 'center', alignItems: 'center'
  },
  itemTitleWrapper_2: {
    width: '30%', backgroundColor: '#3f3f3f', height: 74, justifyContent: 'center', alignItems: 'center'
  },
  itemTitleWrapper_3: {
    width: '30%', backgroundColor: '#3f3f3f', height: 74, justifyContent: 'center', alignItems: 'center'
  },
  ...
  itemPrice: {
    width: '18%', backgroundColor: '#000000', height: 78, justifyContent: 'center', alignItems: 'center', padding: 10, marginRight: '2%', color: '#ffffff'
  },
  itemPriceInputField: {
  ...
  ColBodyText: {
    fontFamily: 'Enter-The-Grid', fontSize: 16, letterSpacing: 1, color: '#ffffff'
  },
  filterWrapper: {
  ...
  assignOrder: {
    ...
    height: 78, justifyContent: 'center', alignItems: 'center'
  },
  assignText: {
    color: '#ffffff',
    fontFamily: 'Enter-The-Grid'
